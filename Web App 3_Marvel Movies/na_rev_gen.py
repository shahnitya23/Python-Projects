...
def app():
    wp = jp.QuasarPage()
    h1 = jp.QDiv(a = wp, text = 'Average Revenue Generated by each Distributor from North America', classes = 'text-h3 text-center q-pa-md')

    hc = jp.HighCharts(a = wp, options = chart_def)
    hc.options.xAxis.categories = list(rev_na.index)
    hc.options.series[0].data = list(rev_na.round(2))
