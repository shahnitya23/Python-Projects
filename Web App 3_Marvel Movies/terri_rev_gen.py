...
def app():
    wp = jp.QuasarPage()
    h1 = jp.QDiv(a = wp, text = 'Average Revenue Generated by each Distributor from Other Territories', classes = 'text-h3 text-center q-pa-md')

    hc = jp.HighCharts(a = wp, options = chart_def)
    hc.options.xAxis.categories = list(rev_terri.index)
    hc.options.series[0].data = list(rev_terri.round(2))
